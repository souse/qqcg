...
// 全局模块 global.js
define("hbecweblib/global/0.2.0/js/global-debug", [ "./sea-baseconfig-debug", "./utility-debug", "seajs/seajs-log/1.0.1/seajs-log-debug", "seajs/seajs-style/1.0.1/seajs-style-debug", "seajs/seajs-text/1.0.2/seajs-text-debug", "jquery/jquery/1.10.2/jquery-debug", "gallery/json/1.0.3/json-debug" ], function(require, exports, module) {
    module.exports = {
 ...
 */
!function() {
    var BASE_RE = /^(.+?\/)(\?\?)?(hbecweblib\/)+/, data = seajs.data, base = data.base;
    if (window.staticFileRoot) {
        data.base = window.staticFileRoot + "/static/hbecweb-modules/";
    } else {
    ...
    seajs.config({
        alias: {
            ...
            // hbecweblib
            bankinput: "hbecweblib/temporary/1.0.0/bankinput",
            dialog: "hbecweblib/dialog/1.0.0/dialog",
            formatter: "hbecweblib/Formatter/0.1.0/Formatter",
            formValidator: "hbecweblib/FormValidator/0.2.1/FormValidator",
            idcard: "hbecweblib/FormValidator/0.2.1/idcard",
            loading: "hbecweblib/loading/1.0.0/loading",
            magnify: "hbecweblib/temporary/1.0.0/magnify",
            numeral: "hbecweblib/temporary/1.0.0/numeral",
            pagination: "hbecweblib/pagination/1.0.0/pagination",
            pwdGrd: "hbecweblib/pwdGrd/1.0.1/pwdGrd",
            "pc-password": "hbecweblib/pwdGrd/1.0.1/pc-password",
            sendotp: "consumer/sendotp/1.0.0/sendotp",
            uploader: "hbecweblib/uploader/0.1.0/Uploader",
            validator: "hbecweblib/Validator/0.1.0/Validator",
            // gallery
            ...
            // hbecweblib
            "bankinput-debug": "hbecweblib/temporary/1.0.0/bankinput-debug",
            "dialog-debug": "hbecweblib/dialog/1.0.0/dialog-debug",
            "formatter-debug": "hbecweblib/Formatter/0.1.0/Formatter-debug",
            "formValidator-debug": "hbecweblib/FormValidator/0.2.1/FormValidator-debug",
            "idcard-debug": "hbecweblib/FormValidator/0.2.1/idcard-debug",
            "loading-debug": "hbecweblib/loading/1.0.0/loading-debug",
            "magnify-debug": "hbecweblib/temporary/1.0.0/magnify-debug",
            "numeral-debug": "hbecweblib/temporary/1.0.0/numeral-debug",
            "pagination-debug": "hbecweblib/pagination/1.0.0/pagination-debug",
            "pwdGrd-debug": "hbecweblib/pwdGrd/1.0.1/pwdGrd-debug",
            "pc-password-debug": "hbecweblib/pwdGrd/1.0.1/pc-password-debug",
            "sendotp-debug": "consumer/sendotp/1.0.0/sendotp-debug",
            "uploader-debug": "hbecweblib/uploader/0.1.0/Uploader-debug",
            "validator-debug": "hbecweblib/Validator/0.1.0/Validator-debug",
            // gallery
    ...
    define("hbecweblib/global/0.2.0/sea-baseconfig-debug", [], {});
}();
...
!function() {
    ...
    define("hbecweblib/global/0.2.0/utility-debug", [], {});
}();
