define(function(require, exports, module) {
	...
	ErrorPopUp.prototype = {
		...
		fnConfirmIng : function(e) {
			...
			var hasError = Confirm.opts.callbacks.fnConfirmIng 
		...
		fnCancle: function(e) {
			var Confirm = e.data.scope;
			Confirm.opts.callbacks.fnCancle
				&& Confirm.opts.callbacks.fnCancle();
			Confirm.mask.remove();
			Confirm.destroy();
			return false;
	...
	ErrorPopUp.defaults = {
		'parent' : 'body',
		'sHtml': '<div class="title-fail"><span id="close" class="cancle"></span></div>'+
		 			'<div class="nav-fail">'+
		 				'<div class="nav-fail-msg textset">系统异常，请稍后再试。</div>'+
					 '<div class="textset">'+
						 '<input type="button" id="confirm" class="fail-confirm" value="确定">'+
					 '</div>'+
				 '</div>',
		callbacks: {
			fnConfirmIng: function(){window.console && console.log('fnConfirmIng'); return false;},
