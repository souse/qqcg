 ...
 * @version 1.0.0
 */
define("pafweblib/pwdGrd/1.0.1/pwdGrd-debug", [ "jquery/jquery-ui/1.10.4/jquery-ui-debug", "./pc-password-debug", "./encryptor-debug", "./password-rule-debug", "validator-debug" ], function(require, exports, module) {
    require("jquery/jquery-ui/1.10.4/jquery-ui-debug");
    var passwordModule = require("./pc-password-debug");
...
// 依赖encryptor.js
// 依赖password-rule.js
define("pafweblib/pwdGrd/1.0.1/pc-password-debug", [ "pafweblib/pwdGrd/1.0.1/encryptor-debug", "pafweblib/pwdGrd/1.0.1/password-rule-debug", "validator-debug" ], function(require, exports, module) {
    ...
    var validator = require("validator-debug");
