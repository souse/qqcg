// 依赖encryptor.js
// 依赖password-rule.js
define("pafweblib/pwdGrd/1.0.1/pc-password-debug", [ "./encryptor-debug", "./password-rule-debug", "validator-debug" ], function(require, exports, module) {
    var encryptorPassword = require("./encryptor-debug");
    var passwordRules = require("./password-rule-debug");
