...
// 全局模块 global.js
define("weblib/global/0.2.0/js/global-debug", [ "./sea-baseconfig-debug", "./utility-debug", "seajs/seajs-log/1.0.1/seajs-log-debug", "seajs/seajs-style/1.0.1/seajs-style-debug", "seajs/seajs-text/1.0.2/seajs-text-debug", "jquery/jquery/1.10.2/jquery-debug", "gallery/json/1.0.3/json-debug" ], function(require, exports, module) {
    module.exports = {
 ...
 */
!function() {
    var BASE_RE = /^(.+?\/)(\?\?)?(weblib\/)+/, data = seajs.data, base = data.base;
    if (window.staticFileRoot) {
        data.base = window.staticFileRoot + "/static/web-modules/";
    } else {
    ...
    seajs.config({
        alias: {
            ...
            // weblib
            bankinput: "weblib/temporary/1.0.0/bankinput",
            dialog: "weblib/dialog/1.0.0/dialog",
            formatter: "weblib/Formatter/0.1.0/Formatter",
            formValidator: "weblib/FormValidator/0.2.1/FormValidator",
            idcard: "weblib/FormValidator/0.2.1/idcard",
            loading: "weblib/loading/1.0.0/loading",
            magnify: "weblib/temporary/1.0.0/magnify",
            numeral: "weblib/temporary/1.0.0/numeral",
            pagination: "weblib/pagination/1.0.0/pagination",
            pwdGrd: "weblib/pwdGrd/1.0.1/pwdGrd",
            "pc-password": "weblib/pwdGrd/1.0.1/pc-password",
            sendotp: "consumer/sendotp/1.0.0/sendotp",
            uploader: "weblib/uploader/0.1.0/Uploader",
            validator: "weblib/Validator/0.1.0/Validator",
            // gallery
            ...
            // weblib
            "bankinput-debug": "weblib/temporary/1.0.0/bankinput-debug",
            "dialog-debug": "weblib/dialog/1.0.0/dialog-debug",
            "formatter-debug": "weblib/Formatter/0.1.0/Formatter-debug",
            "formValidator-debug": "weblib/FormValidator/0.2.1/FormValidator-debug",
            "idcard-debug": "weblib/FormValidator/0.2.1/idcard-debug",
            "loading-debug": "weblib/loading/1.0.0/loading-debug",
            "magnify-debug": "weblib/temporary/1.0.0/magnify-debug",
            "numeral-debug": "weblib/temporary/1.0.0/numeral-debug",
            "pagination-debug": "weblib/pagination/1.0.0/pagination-debug",
            "pwdGrd-debug": "weblib/pwdGrd/1.0.1/pwdGrd-debug",
            "pc-password-debug": "weblib/pwdGrd/1.0.1/pc-password-debug",
            "sendotp-debug": "consumer/sendotp/1.0.0/sendotp-debug",
            "uploader-debug": "weblib/uploader/0.1.0/Uploader-debug",
            "validator-debug": "weblib/Validator/0.1.0/Validator-debug",
            // gallery
    ...
    define("weblib/global/0.2.0/sea-baseconfig-debug", [], {});
}();
...
!function() {
    ...
    define("weblib/global/0.2.0/utility-debug", [], {});
}();
